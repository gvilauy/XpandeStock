...
public class X_Z_StkTransfer extends PO implements I_Z_StkTransfer, I_Persistent 
{
    ...
    {
      super (ctx, Z_StkTransfer_ID, trxName);
      /** if (Z_StkTransfer_ID == 0)
        {
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_Z_StkTransfer (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_StkTransfer[")
	...
	public void setZ_StkTransfer_ID (int Z_StkTransfer_ID)
	{
		if (Z_StkTransfer_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_StkTransfer_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_StkTransfer_ID, Integer.valueOf(Z_StkTransfer_ID));
	}
