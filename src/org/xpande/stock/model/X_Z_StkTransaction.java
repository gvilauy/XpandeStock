...
/** Generated Model for Z_StkTransaction
 *  @author Adempiere (generated) 
 *  @version Release 3.9.1 - $Id$ */
public class X_Z_StkTransaction extends PO implements I_Z_StkTransaction, I_Persistent 
{
      ...
      /** if (Z_StkTransaction_ID == 0)
        {
			...
			setSigno (0);
			setZ_StkStatus_ID (0);
			setZ_StkTransaction_ID (0);
        } */
    }

    /** Load Constructor */
    public X_Z_StkTransaction (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_StkTransaction[")
	...
	/** Set Signo.
		@param Signo 
		Signo positivo o negativo en valores de una registro
	  */
	public void setSigno (int Signo)
	{
		set_Value (COLUMNNAME_Signo, Integer.valueOf(Signo));
	}

	/** Get Signo.
		@return Signo positivo o negativo en valores de una registro
	  */
	public int getSigno () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Signo);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Z_StkTransaction ID.
		@param Z_StkTransaction_ID Z_StkTransaction ID	  */
	public void setZ_StkTransaction_ID (int Z_StkTransaction_ID)
	{
		if (Z_StkTransaction_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_StkTransaction_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_StkTransaction_ID, Integer.valueOf(Z_StkTransaction_ID));
	}

	/** Get Z_StkTransaction ID.
		@return Z_StkTransaction ID	  */
	public int getZ_StkTransaction_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Z_StkTransaction_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
